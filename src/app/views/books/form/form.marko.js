...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><head><meta charset=utf-8><link rel=stylesheet href=/static/css/bootstrap.min.css><link rel=stylesheet href=/static/css/fontawesome.min.css><link rel=stylesheet href=/static/css/casadocodigo.css></head><body><header class=cabecalhoPrincipal><div class=container><div class=\"row align-items-center\"><div class=col-4><h2 class=logo style=\"color: #fff\">Igor's Bookstore</h2></div><div class=\"cabecalhoPrincipal-navegacao col-8\"><a href=/login class=login>Login</a></div></div></div></header><main class=conteudoPrincipal><div class=container><h1>Cadastro de livros</h1>");
